            ...
            <div class="col-lg-12 margin-tb">
                <div class="card mb-3">
                    <div class="card-header mb-3  border-primary">
                        <h2>Liste des clients  <a class="btn btn-outline-success float-end" href="{{ route('clients.create') }}"> Ajouter un nouveau client</a></h2>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('clients.destroy', $client->id) }}" method="POST">
                                        <a class="btn btn-outline-primary" href="{{ route('clients.show', $client->id) }}">Montrer</a>
                                        <a class="btn btn-outline-success" href="{{ route('clients.edit', $client->id) }}">Éditer</a>
                                        @csrf
                                        @method('DELETE')
